...
[
  {
    ...
    "second_yoy_avg": -6.332857142857151,
    "core10_second_mom": 0.07000000000000739,
    "creis_mom": NaN,
    "creis_yoy": NaN,
    "sales_area_yoy": -8.010428841139984,
    "avg_price_yoy": -7.037580068703065,
    "deposit_yoy": -20.136332651670074,
    "cap_loan_yoy": -23.009457329430305,
    "months_to_sell": 9.541459708712734,
    "new_start_sales_ratio": 0.5312676056338028,
    "completion_sales_ratio": 0.5013572343149808,
    "climate": NaN,
    "climate_score": NaN,
    "credit_score": 0.0,
    "sales_score": 10.0,
    ...
    "inventory_score": 6.0,
    "financing_score": 0.0,
    "climate_policy_score": 0.0,
    "composite_score": 20.0,
    "main_signal": "RED_NO_BOTTOM",
    "recommendation": "居民加杠杆趋势未确认",
    "notes": "v0.3 module scores: credit=0, sales=10, price=4, inventory=6, financing=0, climate=0"
  }
]
```
...
|:---------------------------------------------------|:-------|------:|:---------------|:---------|:----------------------------------------------------------------------------|:--------------------|
| 70城新房 二手房 价格指数                           |        |     0 | []             | error    | Token 缓存已过期（超过 12 小时），需要重新获取                              | 2026-05-09T13:43:10 |
|                                                    |        |       |                |          | 错误: 未找到有效 token。请先运行 --save-token 保存，或使用 --token 参数传入 |                     |
| 房地产开发投资 商品房销售面积 新开工面积 月度 数据 |        |     0 | []             | error    | Token 缓存已过期（超过 12 小时），需要重新获取                              | 2026-05-09T13:43:10 |
|                                                    |        |       |                |          | 错误: 未找到有效 token。请先运行 --save-token 保存，或使用 --token 参数传入 |                     |
| 居民贷款 住户贷款 中长期贷款 月度 数据             |        |     0 | []             | error    | Token 缓存已过期（超过 12 小时），需要重新获取                              | 2026-05-09T13:43:10 |
|                                                    |        |       |                |          | 错误: 未找到有效 token。请先运行 --save-token 保存，或使用 --token 参数传入 |                     |
| 70城新房 二手房 价格指数                           |        |     0 | []             | error    | Token 缓存已过期（超过 12 小时），需要重新获取                              | 2026-05-09T13:42:04 |
|                                                    |        |       |                |          | 错误: 未找到有效 token。请先运行 --save-token 保存，或使用 --token 参数传入 |                     |
| 房地产开发投资 商品房销售面积 新开工面积 月度 数据 |        |     0 | []             | error    | Token 缓存已过期（超过 12 小时），需要重新获取                              | 2026-05-09T13:42:04 |
|                                                    |        |       |                |          | 错误: 未找到有效 token。请先运行 --save-token 保存，或使用 --token 参数传入 |                     |
| 居民贷款 住户贷款 中长期贷款 月度 数据             |        |     0 | []             | error    | Token 缓存已过期（超过 12 小时），需要重新获取                              | 2026-05-09T13:42:03 |
|                                                    |        |       |                |          | 错误: 未找到有效 token。请先运行 --save-token 保存，或使用 --token 参数传入 |                     |
| 70城新房 二手房 价格指数                           |        |     0 | []             | error    | Token 缓存已过期（超过 12 小时），需要重新获取                              | 2026-05-09T13:41:13 |
|                                                    |        |       |                |          | 错误: 未找到有效 token。请先运行 --save-token 保存，或使用 --token 参数传入 |                     |
| 房地产开发投资 商品房销售面积 新开工面积 月度 数据 |        |     0 | []             | error    | Token 缓存已过期（超过 12 小时），需要重新获取                              | 2026-05-09T13:41:12 |
|                                                    |        |       |                |          | 错误: 未找到有效 token。请先运行 --save-token 保存，或使用 --token 参数传入 |                     |
| 居民贷款 住户贷款 中长期贷款 月度 数据             |        |     0 | []             | error    | Token 缓存已过期（超过 12 小时），需要重新获取                              | 2026-05-09T13:41:12 |
|                                                    |        |       |                |          | 错误: 未找到有效 token。请先运行 --save-token 保存，或使用 --token 参数传入 |                     |
| 70城新房 二手房 价格指数                           |        |     0 | []             | error    | Token 缓存已过期（超过 12 小时），需要重新获取                              | 2026-05-09T13:40:15 |
|                                                    |        |       |                |          | 错误: 未找到有效 token。请先运行 --save-token 保存，或使用 --token 参数传入 |                     |
...
|:-----------------------------------|:---------|-------:|:-------------------------------------------------------------|:--------------------|
| pbc_credit_tables                  | ok       |   1383 | stock_months=231 monthly_diffs=230 coverage=2007-01..2026-03 | 2026-05-09T13:43:28 |
| pbc_household_manual               | ok       |      9 | manual seed; not complete 2000-now series                    | 2026-05-09T13:43:10 |
| pbc_household_monthly_from_reports | ok       |      6 | monthly values parsed or derived from YTD snippets           | 2026-05-09T13:43:10 |
| pbc_report_snippets                | ok       |      4 | parsed PBOC monthly/YTD snippets                             | 2026-05-09T13:43:10 |
| neodata_validation                 | ok       |      3 | validation queries completed                                 | 2026-05-09T13:43:10 |
| westock_investment                 | ok       |   3088 | years=2000-2026                                              | 2026-05-09T13:43:10 |
| real_estate_climate                | ok       |    326 |                                                              | 2026-05-09T13:43:09 |
| new_financial_credit               | ok       |    219 |                                                              | 2026-05-09T13:43:08 |
| 70_city_house_price                | ok       |  51606 | raw rows=12834; unique city rows=12810; fresh                | 2026-05-09T13:43:08 |
